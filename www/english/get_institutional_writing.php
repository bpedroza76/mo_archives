...
{
echo "<a href='get_institutional_detailed.php?code=$code&amp;title=$title'>$title</a>&nbsp;&nbsp;";
//echo "<input type='submit' style='margin-top:margin-left:0px;0px;font-family:Tahoma;font-size:13px;text-align:left;background-color:F0E8CE;width:395px;color:000000' value='$title'><input type='hidden' name='code' value='$code'><input type='hidden' name='title' value='$title'>&nbsp;&nbsp;";
}
if ($year=="")
{
echo "";
