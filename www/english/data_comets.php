...
?>
  ...
  <tr>
    <td height="137" valign="top"><table width="731" border="0" align="center" cellpadding="2" cellspacing="3" class="table2">
      <tr>
        <td height="59" valign="top"><p class="l_text">COMETS</p>
          <p class="m_text"> 
<?php
...
$query = "SELECT COUNT(code) FROM data_records WHERE code LIKE '%COM%'"; 
...
?>           
          ...
          <p class="m_text"><span class="m_text">I.</span>
                    ...
                    <input type="hidden" name="name" value="COMETS">
                    <input type="hidden" name="category" value="REPORTS AND OBSERVATIONS">
                    <input type="hidden" name="ef" value="E/F No.: XXII COM S1">
                    <input type="hidden" name="database" value="data_records">
					<input type="hidden" name="type" value="comets_reports">
			</form>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <input type="hidden" name="ef" value="E/F No.: XXII COM S2.1">
        <input type="hidden" name="database" value="data_records">
		<input type="hidden" name="type" value="comets_in">
                 </form></td>
                 <td><form name="submit_correspondence" method="post" action="get_correspondence_out.php">
                     ...
                     <input type="hidden" name="ef" value="E/F No.: XXII COM S2.2">
                     <input type="hidden" name="database" value="data_records">
					 <input type="hidden" name="type" value="comets_out">
                 </form>
          </td>
      </tr>
    </table>
