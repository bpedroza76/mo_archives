...
?>
  ...
  <tr>
    <td height="137" valign="top"><table width="731" border="0" align="center" cellpadding="2" cellspacing="3" class="table2">
      <tr>
        <td height="59" valign="top"><p class="l_text">DROUGHTS</p>
          <p class="m_text"> 
<?php
...
$query = "SELECT COUNT(code) FROM data_records WHERE code LIKE '%DRO%'"; 
...
?>          
          ...
          <p class="m_text"> <span class="m_text">I. </span>&nbsp;&nbsp;&nbsp;
                    ...
                    <input type="hidden" name="name" value="DROUGHTS">
                    <input type="hidden" name="category" value="REPORTS AND OBSERVATIONS">
                    <input type="hidden" name="ef" value="E/F No.: XXIII DRO S1">
                    <input type="hidden" name="database" value="data_records">
					<input type="hidden" name="type" value="droughts_reports">
			</form>
