...
?>
  ...
  <tr>
    <td height="137" valign="top"><table width="731" border="0" align="center" cellpadding="2" cellspacing="3" class="table2">
      <tr>
        <td height="59" valign="top"><p class="l_text">LIGHTNING AND THUNDER </p>
          <p class="m_text"> 
<?php
...
$query = "SELECT COUNT(code) FROM data_records WHERE code LIKE '%LIG%'"; 
...
?>          
          ...
          <p class="m_text"> <span class="m_text">I. </span>&nbsp;&nbsp;&nbsp;
                    ...
                    <input type="hidden" name="name" value="LIGHTNING AND THUNDER">
                    <input type="hidden" name="category" value="REPORTS AND OBSERVATIONS">
                    <input type="hidden" name="ef" value="E/F No.: XXVII LIG S1">
                    <input type="hidden" name="database" value="data_records">
					<input type="hidden" name="type" value="lightning_reports">
			</form>
			<p><span class="m_text">II.&nbsp;&nbsp;&nbsp;&nbsp;Correspondence</span>
			<table>
               <tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <input type="hidden" name="ef" value="E/F No.: XXVII LIG S2.1">
        <input type="hidden" name="database" value="data_records">
		<input type="hidden" name="type" value="lightning_in">
                 </form></td>
                 <td><form name="submit_correspondence" method="post" action="get_correspondence_out.php">
                     ...
                     <input type="hidden" name="ef" value="E/F No.: XXVII LIG S2.2">
                     <input type="hidden" name="database" value="data_records">
					 <input type="hidden" name="type" value="lightning_out">
                 </form>
          </td>
      </tr>
    </table>
