...
//Donna:Added may 23,05

// void display_call_list ([string query [, string subtitle [, string script]]])

// This function executes the query given in the first argument
// to get a list of calls. It then displays them in an HTML table,
// as links to the script given in the third argument. If no query
// is passed in, or the query fails, the function returns without
