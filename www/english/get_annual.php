...
{
echo "<input type='submit' style='margin-top:0px;font-family:Tahoma;font-size:13px;text-align:left;background-color:F0E8CE;border-style:none;color:D60A0A' value='$title'><input type='hidden' name='code' value='$code'><input type='hidden' name='code' value='$code'><input type='hidden' name='title' value='$title'>&nbsp;&nbsp;";
}
if ($year=="")
{
echo "";
