...
?>
  ...
  <tr>
    <td height="477" valign="top"><table width="731" height="100%" border="0" align="center" cellpadding="2" cellspacing="3" class="table2">
      <tr>
        <td height="59" valign="top"><p class="l_text">OBSERVATORIO DE MANILA ARCHIVOS </p>
<?php
...
echo "<span class='m_text'>Su busqueda <b>$search_query</b>.</span><br><br>";
echo "<span class='m_text'><a href='spanish_search.php'>Haga clic aqui para buscar de nuevo.</a></span><br><br>";
...
echo "<span class='m_text'>Observatorio de Manila Archivos encontro <b>$number</b> coincidecias!</span><br>";
}
...
{
echo "<span class='m_text'>Autor: $fname $lname<br></span>";
}
if ($title=="")
{
echo "<span class='m_text'></span>";
...
{
echo "<span class='m_text'>Titulo: $title </span>";
}
if ($link_file=="")
{
...
{
echo "<span class='m_text'>Fuente: $source <br></span>";
}
if ($volume_no=="")
{
echo "<span class='m_text'></span>";
...
{
echo "<span class='m_text'>Volumen/Tema N<sup>o</sup>.: $volume_no <br></span>";
}
if ($page=="")
{
echo "<span class='m_text'></span>";
...
{
echo "<span class='m_text'>Pagina: $page <br></span>";
}
if ($place_publisher=="")
{
echo "<span class='m_text'></span>";
...
{
echo "<span class='m_text'>Ano de publicacion: $place_publisher <br></span>";
}
if ($publisher==null)
{
echo "<span class='m_text'></span>";
...
{
echo "<span class='m_text'>Editor: $publisher<br></span>";
}
if ($year=="")
{
echo "<span class='m_text'></span>";
...
{
echo "<span class='m_text'>Ano de publicacion: $year <br></span>";
}
if ($description==null)
{
echo "<span class='m_text'></span>";
...
{
echo "<span class='m_text'>Descripcion: $description<br></span>";
}
if ($note==null)
{
echo "<span class='m_text'></span>";
...
{
echo "<span class='m_text'>Nota: $note<br></span>";
}
if ($ef_no==null)
{
echo "<span class='m_text'></span>";
...
{
echo "<span class='m_text'>E/F N<sup>o</sup>.: $ef_no<br></span>";
}
}
print "";
?>
