...
?>
  ...
  <tr>
    <td height="137" valign="top"><table width="731" height="100%" border="0" align="center" cellpadding="2" cellspacing="3" class="table2">
      <tr>
        <td height="59" valign="top"><p class="l_text"><img src="../pictures/coronas.jpg" width="126" height="190" align="left">JOSE CORONAS, S.J.</p>
          <p class="m_text"> 17 textos  archivados</p>
          ...
          <form name="submit_personal" method="post" action="get_personal.php">
            ...
            <input type="hidden" name="name" value="JOSE CORONAS, S.J.">
            <input type="hidden" name="category" value="REGISTROS BIOGRAFICOS">
            <input type="hidden" name="ef" value="E/F No.: IV COR S1">
            <input type="hidden" name="database" value="coronas">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <input type="hidden" name="ef" value="E/F No.: IV COR S2">
        <input type="hidden" name="database" value="coronas">
...
&nbsp;|
        ...
        <input type="hidden" name="ef" value="E/F No.: IV COR S3.1">
        <input type="hidden" name="database" value="coronas">
        <input type="hidden" name="type" value="correspondence_incoming">
              ...
              <td><form name="submit_writing" method="post" action="get_correspondence_out.php">
                  ...
                  <input type="hidden" name="ef" value="E/F No.: IV COR S3.2">
                  <input type="hidden" name="database" value="coronas">
