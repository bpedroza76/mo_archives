...
?>
  ...
  <tr>
    <td height="137" valign="top"><table width="731" height="100%" border="0" align="center" cellpadding="2" cellspacing="3" class="table2">
      <tr>
        <td height="59" valign="top"><p class="l_text"><img src="../pictures/miller.jpg" width="125" height="189" align="left">RICHARD A. MILLER, S.J.</p>
          <p class="m_text"> 435 textos  archivados </p>
          ...
          <form name="submit_personal" method="post" action="get_personal.php">
            ...
            <input type="hidden" name="name" value="RICHARD A. MILLER, S.J.">
            <input type="hidden" name="category" value="REGISTROS BIOGRAFICOS">
            <input type="hidden" name="ef" value="E/F No.: XIII MIL S1">
            <input type="hidden" name="database" value="miller">
...
&nbsp;|&nbsp;
        ...
        <input type="hidden" name="ef" value="E/F No.: XIII MIL S2.1">
        <input type="hidden" name="database" value="miller">
        <input type="hidden" name="type" value="writings_published">
              ...
              <td><form name="submit_writing" method="post" action="get_writing.php">
                  ...
                  <input type="hidden" name="ef" value="E/F No.: XIII MIL S2.2">
                  <input type="hidden" name="database" value="miller">
...
&nbsp;|
        ...
        <input type="hidden" name="ef" value="E/F No.: XIII MIL S3.1">
        <input type="hidden" name="database" value="miller">
        <input type="hidden" name="type" value="correspondence_incoming">
              ...
              <td><form name="submit_correspondence" method="post" action="get_correspondence_out.php">
                  ...
                  <input type="hidden" name="ef" value="E/F No.: XIII MIL S3.2">
                  <input type="hidden" name="database" value="miller">
