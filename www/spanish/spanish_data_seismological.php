...
<title>Archives of Manila Observatory</title>
...
?>
  ...
  <tr>
    <td height="137" valign="top"><table width="731" border="0" align="center" cellpadding="2" cellspacing="3" class="table2">
      <tr>
        <td height="59" valign="top"><p class="l_text">DATOS SISMOL&Oacute;GICOS </p>
          <p class="m_text"> 
            22 expedientes textuales </p>
		   <form name="submit_writing" method="post" action="get_writing.php">
      <p class="m_text"> <span class="m_text">I. </span>&nbsp;&nbsp;&nbsp;
           			<input type="submit" value="Informes y Observaiones" style="font-family:Tahoma;font-size:13px;text-align:left;background-color:F0E8CE;border-style:none;color:D60A0A">
                    <input type="hidden" name="name" value="DATOS SISMOL&Oacute;GICOS">
                    <input type="hidden" name="category" value="INFORMES Y OBSERVACIONES">
                    <input type="hidden" name="ef" value="E/F No.: SEI S1">
                    <input type="hidden" name="database" value="data_records">
					<input type="hidden" name="type" value="seismo_reports">
			</form>
