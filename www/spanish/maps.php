...
?>
  ...
  <tr>
    <td height="137" valign="top"><table width="731" border="0" align="center" cellpadding="2" cellspacing="3" class="table2">
      <tr>
        <td height="59" valign="top"><p class="l_text">PHOTOS &amp; MAPS</p>
          ...
          <table>
            <tr>
              <td><form name="submit_writing" method="post" action="get_maps.php">
				    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<input type="hidden" name="category" value="MAPS, ANNUAL REPORTS">
                    <input type="hidden" name="ef" value="--">
                    <input type="hidden" name="database" value="maps">
					<input type="hidden" name="type" value="maps_ar">
                </form>
                </td>
            </tr>
            <tr>
